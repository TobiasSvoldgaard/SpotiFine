...
export default function MusicTimePeriod({
  ...
  return (
    <div className="w-full h-100 bg-[#0d0d0d] rounded-[14px] px-9 py-6 overflow-hidden flex flex-col">
      <h1 className="text-2xl font-bold mb-4">Time Period</h1>

      <div className="w-full mx-auto flex h-60 justify-evenly text-4xl font-bold text-black">
        <div className="my-auto grid grid-cols-[auto_auto_auto] gap-2 place-items-center text-center select-none">
          <DateControlButton
          ...
          ></DateControlButton>
          <span className="rounded-md w-[110] px-2 bg-white">
            {startDate.toLocaleString("default", { month: "short" })}
          </span>
          <span className="rounded-md w-[70] px-2 bg-white">
